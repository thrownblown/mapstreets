...
var cities = ['Mexico City','New York City','Los Angeles','Toronto','Chicago','Houston','Havana','Montreal','Ecatepec de Morelos','Philadelphia','Guadalajara','Puebla','Santo omingo','Phoenix','León','San Antonio','San Diego','Juárez','Tijuana','Dallas','Zapopan','Calgary','Monterrey','Tegucigalpa','Guatemala City','Nezahualcóyotl','Santiago de Querétaro','San Jose','Port au Prince','Managua','Ottawa','Panama City','Jacksonville','Indianapolis','Austin','Toluca','San Francisco','Edmonton','Chihuahua','Columbus','Naucalpan','Hermosillo','Mérida','Fort Worth','Charlotte','San Luis','Potosí','Aguascalientes','Mississauga','Saltillo','Detroit','Winnipeg','Seattle','Vancouver'];
