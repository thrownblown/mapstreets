var map,
    ...
    mem = {},
    streetName,
    center = [37.76700618798191,-122.427066746521];
...
function recenter(){
  var city = document.getElementById('city').value || 'Dolores Park, San Francisco';
  var state = document.getElementById('state').value || 'CA';
  var zip = document.getElementById('zip').value || 94110; 
  $.ajax({
