...
function getpark(){
  $.ajax({
    url: 'http://api.sfpark.org/sfpark/rest/availabilityservice?response=json',
    dataType: 'jsonp',
    type: 'GET',
    contentType:'json',
    success: function(data) {
